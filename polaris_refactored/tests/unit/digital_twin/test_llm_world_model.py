...
NOTE: This file was moved from src/digital_twin/test_llm_world_model.py
      to the proper tests directory structure.
"""
...
from digital_twin.llm_world_model import LLMWorldModel, SystemStateNarrator
